 ...
 <div>
   <q-toolbar style="height: 55px; font-size: 16px; padding: 0">
     ...
     <div class="flex column text-center text-black col-6">
       <span class="text-bold" style="font-size: 17px; margin-top: 5px">Search</span>
       <span class="text-caption text-blue-grey-12" style="margin-top: -3px">{{ currentStorage.DisplayName }}</span>
     </div>
