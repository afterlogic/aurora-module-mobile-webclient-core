export default {
  ...
  SET_SELECT_STATUS: (state) => state.currentFile.isSelected = !state.currentFile.isSelected,
  ...
  SET_DIALOG_COMPONENT: (state, dialogComponent) => state.dialogComponent = dialogComponent,
