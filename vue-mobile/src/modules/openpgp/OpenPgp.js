 ...
 */
COpenPgp.prototype.generateKey = function (
  sUserID,
  sPassword,
  nKeyLength,
  fOkHandler,
  ...
  openpgp.generateKey(oOptions).then(
    async (oKeyPair) => {
 ...
 * @returns {Promise}
 */
COpenPgp.prototype.getPrivateOwnKeyAndPassphrase = function (
  sEmail,
  fAskForKeyPassword
) {
 ...
 * @retunr {Object|null}
 */
COpenPgp.prototype.getEncryptionKeyFromArmoredMessage = async function (
  sArmoredMessage
) {
 ...
 * @return {Promise}
 */
COpenPgp.prototype.decryptAndVerifyText = function (
  sData,
  oPrivateKey,
  aPublicKeys,
  fAskForKeyPassword
 ...
 * @return {Object}
 */
COpenPgp.prototype.decryptAndVerifyTextWithPassphrase = async function (
  sData,
  oPrivateKey,
  sPassphrase,
  aPublicKeys
  ...
  if (bVerified && oOpenPgpKey) {
    ...
    try {
      ...
      if (oPgpResult && oPgpResult.data) {
        let oResult = {
          sDecryptedData: await openpgp.stream.readToEnd(oPgpResult.data),
        }
        if (
 ...
 * @return {Promise}
 */
COpenPgp.prototype.signText = function (
  sData,
  oPrivateKey,
  fAskForKeyPassword
) {
 ...
 * @return {Object}
 */
COpenPgp.prototype.signTextWithPassphrase = async function (
  sData,
  oPrivateKey,
  sPassphrase
) {
 ...
 * @return {Promise}
 */
COpenPgp.prototype.signAndEncryptText = function (
  sData,
  aPublicKeys,
  oPrivateKey,
  fAskForKeyPassword
 ...
 * @return {Object}
 */
COpenPgp.prototype.signAndEncryptTextWithPassphrase = async function (
  sData,
  aPublicKeys,
  oPrivateKey,
  sPassphrase
 ...
 * @return {Object}
 */
COpenPgp.prototype.encryptData = async function (
  mData,
  sUserEmail,
  aPrincipalsEmail,
 ...
 * @return {Object}
 */
COpenPgp.prototype.encryptDataWithPassphrase = async function (
  mData,
  sUserEmail,
  oPrivateUserKey,
  aPrincipalsEmails,
